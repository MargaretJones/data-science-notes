...
Ok, so we're split between a test set and training set. Let's try fitting our first model! 
...
Literally w. t. f. How is garage size the apparent driving variable??
...
Mmm look at that scatter... I don't think I'm over fitting, but I also have some weak-ass predictive capability. Also, for this slice of data, the test error is actually better than the traning error. Go figure. I knew I might have issues with a tiny dataset. Or it may be that a linear model just isn't the best for this. 
